...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`xkcms` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `db_admin` (
  ...
  `delstate` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除状态，0为显示，1为不显示',
...
insert  into `db_admin`(`id`,`username`,`password`,`nickname`,`levelname`,`delstate`,`loginip`,`logintime`) values (1,'admin','c3284d0f94606de1fd2af172aba15bf3','总管理员',1,0,'127.0.0.1',1489234113),(2,'xieheng','14e1b600b1fd579f47433b88e8d85291','',3,0,'127.0.0.1',1461508544),(3,'heng123','14e1b600b1fd579f47433b88e8d85291','',4,0,'127.0.0.1',1461509028),(4,'admin2','14e1b600b1fd579f47433b88e8d85291','小兵',3,0,'127.0.0.1',1489233591);

/*Table structure for table `db_adminauth` */

DROP TABLE IF EXISTS `db_adminauth`;

CREATE TABLE `db_adminauth` (
  `groupid` tinyint(3) unsigned NOT NULL COMMENT '所属管理组id',
  `model` varchar(30) NOT NULL COMMENT '管理模块'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `db_adminauth` */

insert  into `db_adminauth`(`groupid`,`model`) values (15,'admin'),(15,'authlist'),(15,'infoclass'),(15,'infolist'),(2,'infoflag'),(18,'authlist'),(18,'admin'),(2,'infolist'),(2,'infoclass'),(3,'infolist'),(3,'infoflag'),(4,'authlist'),(4,'admin');

/*Table structure for table `db_admingroup` */

DROP TABLE IF EXISTS `db_admingroup`;

CREATE TABLE `db_admingroup` (
...
/*Data for the table `db_admingroup` */

insert  into `db_admingroup`(`id`,`groupname`,`description`,`checkinfo`) values (1,'超级管理员','超级管理员组','true'),(2,'站点管理员','站点管理员组','true'),(3,'文章发布员','文章发布员组','true'),(4,'系统管理员','系统管理员组','true');

/*Table structure for table `db_adminlog` */

DROP TABLE IF EXISTS `db_adminlog`;

CREATE TABLE `db_adminlog` (
...
/*Data for the table `db_adminlog` */

insert  into `db_adminlog`(`id`,`uname`,`model`,`action`,`posttime`,`ip`) values (74,'admin','Common','setLog',1489227377,'127.0.0.1'),(75,'admin','Common','setLog',1489227408,'127.0.0.1'),(76,'admin','Common','setLog',1489227414,'127.0.0.1'),(77,'admin','Admin','adminGroup',1489227883,'127.0.0.1'),(78,'admin','Admin','adminGroup',1489227885,'127.0.0.1'),(79,'admin','Admin','adminGroup',1489227889,'127.0.0.1'),(80,'admin','Index','index',1489227945,'127.0.0.1'),(81,'admin','Index','leftMenu',1489227945,'127.0.0.1'),(82,'admin','Index','home',1489227946,'127.0.0.1'),(83,'admin','Admin','adminGroup',1489227950,'127.0.0.1'),(84,'admin','Admin','adminGroup',1489227951,'127.0.0.1'),(85,'admin','Admin','adminGroup',1489227955,'127.0.0.1'),(86,'admin','Admin','adminGroup',1489227956,'127.0.0.1'),(87,'admin','Authlist','index',1489228184,'127.0.0.1'),(88,'admin','Admin','adminGroup',1489228201,'127.0.0.1'),(89,'admin','Index','logout',1489228357,'127.0.0.1'),(90,'admin','Index','index',1489228923,'127.0.0.1'),(91,'admin','Index','logout',1489228989,'127.0.0.1'),(92,'admin2','Login','login',1489229000,'127.0.0.1'),(93,'admin2','Index','index',1489229000,'127.0.0.1'),(94,'admin','Login','login',1489229045,'127.0.0.1'),(95,'admin','Admin','index',1489233484,'127.0.0.1'),(96,'admin','Index','logout',1489233568,'127.0.0.1'),(97,'admin2','Login','login',1489233591,'127.0.0.1'),(98,'admin2','Infoflag','index',1489233609,'127.0.0.1'),(99,'admin2','Infolist','index',1489233615,'127.0.0.1'),(100,'admin2','Infolist','index',1489234105,'127.0.0.1'),(101,'admin2','Index','logout',1489234107,'127.0.0.1'),(102,'admin','Login','login',1489234113,'127.0.0.1'),(103,'admin','Admin','adminGroup',1489234287,'127.0.0.1'),(104,'admin','Infolist','index',1489234290,'127.0.0.1'),(105,'admin','Infolist','index',1489234999,'127.0.0.1'),(106,'admin','Infoflag','index',1489234999,'127.0.0.1'),(107,'admin','Infoflag','flagUpdate',1489235173,'127.0.0.1'),(108,'admin','Infoflag','index',1489235241,'127.0.0.1'),(109,'admin','Infoflag','flagUpdate',1489235346,'127.0.0.1');

/*Table structure for table `db_authlist` */

DROP TABLE IF EXISTS `db_authlist`;

CREATE TABLE `db_authlist` (
  `id` int(8) NOT NULL AUTO_INCREMENT COMMENT '模块id',
  `model` varchar(20) NOT NULL COMMENT '模块名',
  `description` varchar(30) NOT NULL COMMENT '模块说明',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `db_authlist` */

insert  into `db_authlist`(`id`,`model`,`description`) values (1,'admin','管理员模块'),(2,'authlist','权限模块管理'),(3,'infoclass','栏目管理模块'),(4,'infolist','文章管理模块'),(6,'infoflag','文章属性管理模块');

/*Table structure for table `db_infoclass` */

DROP TABLE IF EXISTS `db_infoclass`;

CREATE TABLE `db_infoclass` (
...
/*Data for the table `db_infoclass` */

insert  into `db_infoclass`(`id`,`parentid`,`parentstr`,`infotype`,`classname`,`picurl`,`content`,`seotitle`,`keywords`,`description`,`orderid`,`checkinfo`) values (1,0,'0,',0,'网站公告','20170305/58bbbaa07051f.jpg','&lt;p&gt;rewrerewrwerwerwe&lt;br/&gt;&lt;/p&gt;','士大夫','飞','飞',14,'true'),(4,0,'0,',1,'新闻动态','','','121','','',14,'true'),(5,0,'0,',2,'产品展示','332432','','','','',14,'true'),(7,5,'0,5,',1,'智能手机','',NULL,'','','',7,'true'),(8,0,'0,',1,'成功案例','','','','','',14,'false'),(9,0,'0,',0,'联系我们','','','','','',14,'true'),(15,6,'0,5,6',0,'华硕笔记本','',NULL,'笔记本 华硕','笔记本 华硕','笔记本 华硕',14,'true'),(16,0,'0',0,'3434343','',NULL,'','','',15,'true'),(17,16,'0,16,',0,'sdfsdf','20170305/58bbb847c08e2.jpg',NULL,'','','',14,'true'),(19,0,'0,',0,'32423','20170305/58bbb6a60ce4d.jpg','士大夫士大夫','','','第三方电饭锅',14,'true'),(20,0,'0,',0,'3232','',NULL,'','','',14,'true'),(21,0,'0',0,'34324234234','20170305/58bbba1c7511a.jpg',NULL,'','','',16,'true'),(22,1,'0,1',0,'232','','','','','',17,'true');

/*Table structure for table `db_infoflag` */

DROP TABLE IF EXISTS `db_infoflag`;

CREATE TABLE `db_infoflag` (
...
/*Data for the table `db_infoflag` */

insert  into `db_infoflag`(`id`,`flag`,`flagname`,`orderid`) values (1,'h','头条',1),(2,'c','推荐',2),(9,'t','置顶',4),(8,'w','活动',3);

/*Table structure for table `db_infolist` */

DROP TABLE IF EXISTS `db_infolist`;

CREATE TABLE `db_infolist` (
